...
class AchievementLedger:
    """Ledger for recording achievements, progress, and game grants."""

    def __init__(self, username: str) -> None:
        """Create a ledger instance scoped to `username`."""
    ...
    def record_feat(self, game_id: str, def_id: str) -> None:
        """Unlock a one-time feat for the user in the given game."""
                    ...
                    for tier, threshold in sorted(
                        ...
                        if new_total >= threshold:
                            ...
                            if not cur.fetchone():
                                ...
                                cur.execute(
                                    insert_unlock_q, (self.username, def_id, tier)
                                )
                            break
