...
class GameAnnotator:
    ...
    def annotate_game_moves(self, moves_string: str, move_evals: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], str]:
        """
        ...
        exporter = chess.pgn.StringExporter(columns=None, comments=True, variations=True)
